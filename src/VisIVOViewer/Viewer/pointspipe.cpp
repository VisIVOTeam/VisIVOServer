...
//------------------------------------------------------------------------------------
{
  ...
  if (m_visOpt.radiusscalar != "none" && m_visOpt.scaleGlyphs != "none" && m_visOpt.nGlyphs != 0)
  {
    if (m_visOpt.color == "none")
    {
      ...
      if (m_visOpt.oneColor == "yellow")
        m_visOpt.nColorTable = 19;
      if (m_visOpt.oneColor == "red")
        m_visOpt.nColorTable = 24;
      if (m_visOpt.oneColor == "green")
        m_visOpt.nColorTable = 25;
      if (m_visOpt.oneColor == "blue")
        m_visOpt.nColorTable = 26;
      if (m_visOpt.oneColor == "cyan")
        m_visOpt.nColorTable = 20;
      if (m_visOpt.oneColor == "violet")
        m_visOpt.nColorTable = 21;
      if (m_visOpt.oneColor == "black")
        m_visOpt.nColorTable = 23;
    ...
    if (m_visOpt.dataRead && m_visOpt.goodAllocation)
    {
      ...
      std::map<std::string, int>::iterator p;
      for (p = m_visOpt.columns.begin(); p != m_visOpt.columns.end(); p++)
        if (p->first == m_visOpt.radiusscalar)
          iRadius = p->second;
      for (i = 0; i < m_visOpt.nRows; i++)
  ...
  if (m_visOpt.heightscalar != "none" && m_visOpt.scaleGlyphs != "none" && m_visOpt.nGlyphs != 0 && m_visOpt.nGlyphs != 1)
  {
    ...
    if (m_visOpt.dataRead && m_visOpt.goodAllocation)
    {
      ...
      std::map<std::string, int>::iterator p;
      for (p = m_visOpt.columns.begin(); p != m_visOpt.columns.end(); p++)
        if (p->first == m_visOpt.heightscalar)
          iheight = p->second;
      for (i = 0; i < m_visOpt.nRows; i++)
  ...
  if (m_visOpt.colorScalar != "none")
  {
    ...
    if (m_visOpt.dataRead && m_visOpt.goodAllocation)
    {
      ...
      std::map<std::string, int>::iterator p;
      for (p = m_visOpt.columns.begin(); p != m_visOpt.columns.end(); p++)
        if (p->first == m_visOpt.colorScalar)
          ilut = p->second;
      for (i = 0; i < m_visOpt.nRows; i++)
...
*/
  ...
  if (m_visOpt.color == "none")
  {
    ...
    if (m_visOpt.oneColor == "green")
      P->SetColor(0, 1, 0);
    if (m_visOpt.oneColor == "blu")
      P->SetColor(0, 0, 1);
    if (m_visOpt.oneColor == "cyane")
      P->SetColor(0, 1, 1);
    if (m_visOpt.oneColor == "violet")
      P->SetColor(1, 0, 1);
    if (m_visOpt.oneColor == "black")
  ...
  if (m_visOpt.backColor == "yellow")
    m_pRenderer->SetBackground(1, 1, 0);
  if (m_visOpt.backColor == "red")
    m_pRenderer->SetBackground(1, 0, 0);
  if (m_visOpt.backColor == "green")
    m_pRenderer->SetBackground(0, 1, 0);
  if (m_visOpt.backColor == "blue")
    m_pRenderer->SetBackground(0, 0, 1);
  if (m_visOpt.backColor == "cyan")
    m_pRenderer->SetBackground(0, 1, 1);
  if (m_visOpt.backColor == "violet")
    m_pRenderer->SetBackground(1, 0, 1);
  if (m_visOpt.backColor == "white")
...
//---------------------------------------------------------------------
{
  ...
  if (m_visOpt.isColorRangeFrom)
    b[0] = m_visOpt.colorRangeFrom;
  if (m_visOpt.isColorRangeTo)
    b[1] = m_visOpt.colorRangeTo;
  if (b[1] <= b[0])
    b[1] = b[0] + 0.0001;
...
//-------------------------------------------------------------------------
{
  ...
  {
    if (zField && (xField->GetNumberOfComponents() != zField->GetNumberOfComponents() || yField->GetNumberOfComponents() != zField->GetNumberOfComponents()))
    {
      false;
    }
